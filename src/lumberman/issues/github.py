...
from lumberman.issues.provider import Issue, IssueComment, RemoteIssue, _parse_issue_comment
...
@dataclass
class GithubIssue(RemoteIssue, Issue):
    entity_id: str
    title: IssueTitle
    description: str
    ...
    def render(self) -> str:
        return f"{self.title.content} #{self.entity_id}"
